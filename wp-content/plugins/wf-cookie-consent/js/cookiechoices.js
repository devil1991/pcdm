    ...
    var cookieChoices = (function() {
        ...
        function showCookieBar(data) {
            ...
            if (typeof data != 'undefined' && typeof data.linkHref != 'undefined') {
                ...
                data.styles = data.styles || 'position:fixed; width:100%; color:#fff; background-color:#333; margin:0; left:0; ' + data.position + ':0; padding:4px; z-index:9000; text-align:center;font-size:15px';
	    ...
	    infoLink.style.textTransform = 'none';
