...
class PcdmIcons {
  ...
  const TYPE_IDENTIFIER = 'pcdm_icons';

  /**
   * Definisce il prefisso per i capi per questo tipo di dato
   */
  const TYPE_PREFIX = 'pcdm_icons_';
  ...
  public function __construct() {
    ...
    add_image_size('pcdm_icons_wall_image', 1680, 788, FALSE);
  }
  ...
  public function defineType() {
    ...
    $labels = array(
        ...
        'singular_name' => _x('Icons', 'post type singular name'),
        'add_new' => _x('Add New', 'home item'),
        'add_new_item' => __('Add Icon'),
        'edit_item' => __('Edit Icon Item'),
        'new_item' => __('New Icon Item'),
        'view_item' => __('View Icon Item'),
  ...
  public function defineFields($meta_boxes) {
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
            array(
                'name' => 'Description',
                'desc' => 'Specify a description for this icon.',
